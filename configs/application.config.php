 ...
 */
 ...
 $cachePrefix = APPLICATION_SITE . '.' . APPLICATION_LANGUAGE;
...
return [
    ...
    'module_listener_options' => [
        ...
        // subsequent requests.
        'config_cache_enabled' => ENABLE_CONFIG_CACHE[APP_ENV_VERSION],

        // The key used to create the configuration cache file name.
        'config_cache_key' => "{$cachePrefix}.app.config.cache",
        ...
        'module_map_cache_key' => "{$cachePrefix}.app.module.cache",
